...
Files have to be in a folder and in the form of an Image format like png.
The order at which files are displayed is based on alpabetical order.
Image Scaling is implemented.
If you want a way to track your reading progress just create a "list.txt" file in your your home/Dokumente folder. 
(I might rework this to be more intuitive if i get annoyed with the way it is now)
